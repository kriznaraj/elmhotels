      ...
      return function () {
         ...
         _L.fromArray([A2($Html.h3,
                      ...
                      _L.fromArray([A2($Html.label,
                                   ...
                                   ,A2($Html.input,
                                   _L.fromArray([$Html$Attributes.placeholder("Mininum Rating")
                                                ,$Html$Attributes.type$("range")
                                                ,$Html$Attributes.min("0")
                                                ,$Html$Attributes.max("10")
                                                ,$Html$Attributes.value($Basics.toString(criteria.filter.minRating))
                                                ,A3($Html$Events.on,
                                                "input",
                                                $Html$Events.targetValue,
                                                function (str) {
                      ...
                      _L.fromArray([A2($Html.label,
                                   ...
                                   ,A2($Html.input,
                                   _L.fromArray([$Html$Attributes.placeholder("Mininum Price")
                                                ,$Html$Attributes.type$("range")
                                                ,$Html$Attributes.min("0")
                                                ,$Html$Attributes.max("7000")
                                                ,$Html$Attributes.value($Basics.toString(criteria.filter.minPrice))
                                                ,A3($Html$Events.on,
                                                "input",
                                                $Html$Events.targetValue,
                                                function (str) {
