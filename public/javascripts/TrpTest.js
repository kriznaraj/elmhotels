...
var _julianjelfs$elmhotels$Autocompleter_Types$LoadResults = function (a) {
	return {ctor: 'LoadResults', _0: a};
};
...
var _julianjelfs$elmhotels$Models$HotelsLoad = function (a) {
	return {ctor: 'HotelsLoad', _0: a};
};
...
var _julianjelfs$elmhotels$Header$header = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Travel Republic'),
		_1: {ctor: '[]'}
	});
...
if (typeof _julianjelfs$elmhotels$TrpTest$main !== 'undefined') {
    _julianjelfs$elmhotels$TrpTest$main(Elm['TrpTest'], 'TrpTest', {"types":{"message":"Models.Msg","aliases":{"Destination.DestinationList":{"type":"List Destination.Destination","args":[]},"Models.Filter":{"type":"{ stars : List Int , minRating : Float , hotelName : String , minPrice : Float }","args":[]},"Models.HotelList":{"type":"List Models.Hotel","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]},"Models.Hotel":{"type":"{ name : String , thumbnail : String , image : String , stars : Int , rating : Float , price : Float }","args":[]},"Models.Pager":{"type":"{ pageSize : Int, pageIndex : Int }","args":[]},"Destination.Destination":{"type":"{ countryId : Int , provinceId : Int , locationId : Int , placeId : Int , establishmentId : Int , polygonId : Int , establishmentCount : Int , title : String }","args":[]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Autocompleter.Types.Msg":{"tags":{"LoadResults":["Result.Result Http.Error Destination.DestinationList"],"SelectDestination":["Destination.Destination"],"QueryChanged":["String"]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Models.Msg":{"tags":{"AutocompleterUpdate":["Autocompleter.Types.Msg"],"PageChange":["Models.Pager"],"NoOp":[],"FilterChange":["Models.Filter"],"SortChange":["Models.SortOrder"],"HotelsLoad":["Result.Result Http.Error Models.HotelList"]},"args":[]},"Models.SortOrder":{"tags":{"Price":[],"HotelName":[],"Rating":[],"Stars":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
