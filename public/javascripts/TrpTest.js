...
var _julianjelfs$elmhotels$Destination$Destination = F8(
...
var _julianjelfs$elmhotels$Models$Filter = F4(
	function (a, b, c, d) {
		return {stars: a, minRating: b, hotelName: c, minPrice: d};
	});
var _julianjelfs$elmhotels$Models$initialFilter = A4(
	...
	'',
	0);
var _julianjelfs$elmhotels$Models$Pager = F2(
	function (a, b) {
		return {pageSize: a, pageIndex: b};
	});
var _julianjelfs$elmhotels$Models$initialPager = A2(_julianjelfs$elmhotels$Models$Pager, 20, 0);
var _julianjelfs$elmhotels$Models$Hotel = F6(
	function (a, b, c, d, e, f) {
		return {name: a, thumbnail: b, image: c, stars: d, rating: e, price: f};
	});
var _julianjelfs$elmhotels$Models$Criteria = F3(
	function (a, b, c) {
		return {filter: a, sort: b, paging: c};
	});
var _julianjelfs$elmhotels$Models$Model = F4(
	function (a, b, c, d) {
		return {hotels: a, total: b, criteria: c, autocompleter: d};
	});
var _julianjelfs$elmhotels$Models$Price = {ctor: 'Price'};
var _julianjelfs$elmhotels$Models$HotelName = {ctor: 'HotelName'};
var _julianjelfs$elmhotels$Models$initialSortOrder = _julianjelfs$elmhotels$Models$HotelName;
var _julianjelfs$elmhotels$Models$Rating = {ctor: 'Rating'};
var _julianjelfs$elmhotels$Models$Stars = {ctor: 'Stars'};
var _julianjelfs$elmhotels$Models$AutocompleterUpdate = function (a) {
	return {ctor: 'AutocompleterUpdate', _0: a};
};
var _julianjelfs$elmhotels$Models$SortChange = function (a) {
	return {ctor: 'SortChange', _0: a};
};
var _julianjelfs$elmhotels$Models$FilterChange = function (a) {
	return {ctor: 'FilterChange', _0: a};
};
var _julianjelfs$elmhotels$Models$PageChange = function (a) {
	return {ctor: 'PageChange', _0: a};
};
var _julianjelfs$elmhotels$Models$HotelsLoadFailed = function (a) {
	return {ctor: 'HotelsLoadFailed', _0: a};
};
var _julianjelfs$elmhotels$Models$HotelsLoadSucceeded = function (a) {
	return {ctor: 'HotelsLoadSucceeded', _0: a};
};
var _julianjelfs$elmhotels$Models$NoOp = {ctor: 'NoOp'};
...
var _julianjelfs$elmhotels$SortBar$view = function (sort) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('sort-bar')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A3(_julianjelfs$elmhotels$SortBar$sortButton, sort, _julianjelfs$elmhotels$Models$HotelName, 'Name'),
				A3(_julianjelfs$elmhotels$SortBar$sortButton, sort, _julianjelfs$elmhotels$Models$Stars, 'Stars'),
				A3(_julianjelfs$elmhotels$SortBar$sortButton, sort, _julianjelfs$elmhotels$Models$Rating, 'Rating'),
				A3(_julianjelfs$elmhotels$SortBar$sortButton, sort, _julianjelfs$elmhotels$Models$Price, 'Price')
			]));
};
...
var _julianjelfs$elmhotels$Pager$view = F2(
	function (total, paging) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('pager')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('button prev'),
							_elm_lang$html$Html_Attributes$disabled(firstPage),
							_elm_lang$html$Html_Events$onClick(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('total-pages')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('button next'),
							_elm_lang$html$Html_Attributes$disabled(lastPage),
							_elm_lang$html$Html_Events$onClick(
							_julianjelfs$elmhotels$Models$PageChange(
								_elm_lang$core$Native_Utils.update(
									paging,
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Attributes$min(min),
							_elm_lang$html$Html_Attributes$max(max),
...
var _julianjelfs$elmhotels$Filters$addOrRemoveStar = F2(
	function (filter, star) {
		...
		return inList ? _elm_lang$core$Native_Utils.update(
			...
			filter,
			{
				stars: A2(_elm_lang$core$List_ops['::'], star, filter.stars)
			});
	});
var _julianjelfs$elmhotels$Filters$stars = F2(
	function (num, filter) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('stars')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Filters')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$placeholder('Hotel Name'),
								_elm_lang$html$Html_Attributes$autofocus(true),
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$value(filter.hotelName),
								_elm_lang$html$Html_Events$onInput(
								function (str) {
									return _julianjelfs$elmhotels$Models$FilterChange(
										_elm_lang$core$Native_Utils.update(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_julianjelfs$elmhotels$Filters$stars, 5, filter),
								A2(_julianjelfs$elmhotels$Filters$stars, 4, filter),
								A2(_julianjelfs$elmhotels$Filters$stars, 3, filter),
								A2(_julianjelfs$elmhotels$Filters$stars, 2, filter),
								A2(_julianjelfs$elmhotels$Filters$stars, 1, filter)
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('clear')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A6(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Clear Filters')
							]))
					]))
			]));
};

var _julianjelfs$elmhotels$Header$header = A2(
	_elm_lang$html$Html$h1,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Travel Republic')
		]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('hotel-card')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('hotel-image'),
										_julianjelfs$elmhotels$HotelsList$backgroundImage(hotel.image)
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('hotel-overlay')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('truncate')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('hotel-text')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('hotel-price')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('hotel-rating')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('hotel-stars')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(
...
var _julianjelfs$elmhotels$HotelsList$hotelList = function (hotels) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hotel-list')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Loading hotels ...')
					])) : A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[]),
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['TrpTest'], 'TrpTest', typeof _julianjelfs$elmhotels$TrpTest$main === 'undefined' ? null : _julianjelfs$elmhotels$TrpTest$main);
